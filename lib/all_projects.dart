...
List<Project> projects = [
  ...
  Project(
    title: ProjectNames.seekNext,
    image: 'lib/assets/images/project_banners/seek_next.jpg',
    source: 'https://github.com/IITM-Software-Engineering-Project/soft-engg-project-may-2024-se-may-18',
    pagePath: '/home/Seek_Next',
    briefDescription:
        "This is a next generation child of Seek portal used by IIT Madras students to find the best courses by instructors of premier institutes in the country. Apart from the features of original Seek portal, Seek Next is also equipped with GenAI.",
    description: '',
    buttonSecondaryColor: HexColor('#BDD0FB'),
    buttonPrimaryColor: HexColor('#190E8E'),
    primaryColor: HexColor('#BDD0FB'),
    secondaryColor: HexColor('#3234C0'),
    sections: [
      HtmlSection(title: "Description", bodyPath: 'lib/pages/projects/seek_next/description.html'),
      HtmlSection(title: "Milestone One", bodyPath: 'lib/pages/projects/seek_next/milestone_one.html'),
      const PDFSection(title: 'Submission for Milestone 1', pdfPath: 'https://raw.githubusercontent.com/Nailsonseat/Portfolio_Website/master/lib/pages/projects/seek_next/milestone_one.pdf'),
      HtmlSection(title: "Milestone Two", bodyPath: 'lib/pages/projects/seek_next/milestone_two.html'),
      const PDFSection(title: 'Submission for Milestone 2', pdfPath: 'https://raw.githubusercontent.com/Nailsonseat/Portfolio_Website/master/lib/pages/projects/seek_next/milestone_two.pdf'),
      HtmlSection(title: "Milestone Three", bodyPath: 'lib/pages/projects/seek_next/milestone_three.html'),
      HtmlSection(title: "Milestone Four", bodyPath: 'lib/pages/projects/seek_next/in_progress.html'),
    ],
    timelineIcons: [
      Ionicons.bookmark_sharp,
      EvaIcons.fileText,
    ...
    tableOfContents: [
      TableOfContentsComponent(title: "Description", subComponents: []),
      TableOfContentsComponent(title: "Milestone One", subComponents: []),
      TableOfContentsComponent(title: "Submission M1", subComponents: []),
      TableOfContentsComponent(title: "Milestone Two", subComponents: []),
      TableOfContentsComponent(title: "Submission M2", subComponents: []),
      TableOfContentsComponent(title: "Milestone Three", subComponents: []),
    ],
  ),
  Project(
