...
class RPSCustomPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_fill_1.shader = ui.Gradient.linear(Offset(size.width*-0.00,size.height*0.50),Offset(size.width*1.00,size.height*0.50),[Color(0xffa46acf),Color(0xff3fdad0)],[0.00,1.00]);
...
class ProfilePictureBackground extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_fill_0.shader = ui.Gradient.linear(
        Offset(size.width * -0.00, size.height * 0.29),
        Offset(size.width * 1.00, size.height * 0.29),
        [Color(0xffd6ae5d), Color(0xffffffff), Color(0xffcbcbcb), Color(0xffffffff), Color(0xff41cdd6)],
        [0.00, 0.53, 0.73, 0.90, 1.00]);

    Path path_0 = Path();
    path_0.moveTo(size.width * 1.0008333, size.height * -0.0014286);
    path_0.lineTo(size.width * -0.0016667, 0);
    path_0.lineTo(size.width * -0.0016667, size.height * 0.5742857);
    path_0.lineTo(size.width * 1.0016667, size.height * 0.5742857);
